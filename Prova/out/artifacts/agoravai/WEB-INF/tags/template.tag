...
<body>
<header>
    <div class="navbar-fixed default_color" style="z-index: 999">
        <nav>
                ...
                <div class="container">
                    ...
                    <ul class="right hide-on-med-and-down">
                        <c:if test="${!isLoggedIn}">
                            <li><a href="/produto/criar">Novo Produto</a></li>
                        </c:if>
                        <c:if test="${!isLoggedIn}">
                            <li><a href="index.jsp">Meus Produtos</a></li>
                        </c:if>
...
<!-- rodape-->
<footer class="page-footer default_color darken-5">
